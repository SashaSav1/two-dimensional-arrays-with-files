...
//Вычислить произведение четных элементов массива и вывести его на экран. 
//Найти в каждой строке количество четных элементов и вывести найденные значения в текстовый файл в строку.
//Найти минимальный четный элемент массива и вывести его на экран.Если четных элементов нет, то выведите соответствующее сообщение.
//Заменить в  первой строке все однозначные элементы на 0 .
//Вывести измененный массив в текстовый файл в виде матрицы
//Найти произведение номера столбца и номера строки в которых содержится последний максимальный элемент.
//Вычислить количество делителей найденного значения. Оформить алгоритм в виде функции.
